...
**大陆入口（提交号，不要用 @main）:** https://jsd.onmicrosoft.cn/gh/Lelouchzhu/MediDash@c216df9136f27dd902f520e98fbd1547e3cb3d2f/index.xhtml  
...
| 2026-09-26 08:59 | postop 258h59m | **7.209** |

Trend: falling from the 170 peak through **8.206**, then **rose** to **9.893**, then **7.209**. Still far above ref 0–0.05. The 10:04 and 08:59 sheet abbreviation is **PCCT**; the Chinese name is 降钙素原测定. This is not CBC plateletcrit and not P/F.
...
- **Latest bedside (family oral received 2026-09-26 15:00, postop 265h):** BP **110/30**, heart rate **100**. No MAP — do not invent one, and do not carry forward 15:07 MAP or the 9/22 MAP **55**. No respiratory rate on this clock — do not carry the 15:07 RR **14**. Norepinephrine **3 → 5 mL/h = 0.25 mg/h** (concentration 0.05 mg/mL). Dopamine **5 → 4 mL/h**. Do not convert dopamine to mg/h. Do not invent weight. CRRT / 尿量: **上午七点CRRT暂停，仍无尿**. 上午七点 is more specific than 13:00’s 七点多, still not exactly 07:00, and is not a monitor clock. Fever **37.4**. Doctor thinks remaining small intestine is little and eating is temporarily not possible, and mentioned possible abdominal bacterial translocation / secondary infection — record as 医生认为, not a diagnosis. Oral also said sputum/secretion susceptibility found a “new” bacillus (**肺炎克雷伯菌**); wait until tomorrow to decide whether to change antibiotics. Do not invent MIC. The 10:30 sheet already had bacterium 1 **肺炎克雷伯菌** with blank sputum/secretion/CFU and no visible susceptibilities. Stool: basically daily, two stools during the visit, nurses/doctors did not report abnormal color, confirm tomorrow. Do not write 黑褐色 or occult blood onto this clock. No new ventilator number, sedative name, or eye-opening update. **呼吸正压 15–18** is still the **9/22 16:11** phrase. The prior 15:07 oral (122/33, HR 83, RR 14, NE 3, DA 5) stays as the previous chart point.
...
- **Judgment:** PCT rose **8.206 → 9.893**. That clock was the hero until the 13:58 ABG.
...
- PO₂ **66.80↓** (was 64.40). FiO₂ still **60%**. Printed P/F **111↓** (pO2(a)/FO2(I), ref 400–500). 66.80 / 0.60 ≈ 111. The **0.17%** row is not P/F and not procalcitonin.
- Hb **9.50↓** g/dL (was 9.80). Hct **28%**. iCa **1.06↓** (was 1.04). sO₂ **91.40↓**.
- Relative hour **239.98**. Label **术后239h58m**.
- **Judgment:** lactate returned inside the reference. P/F is still far below 400. This arterial clock was the hero until the 15:07 oral. Do not add a `vitalReadings` point from the 13:58 sheet.

### Bedside oral — received 2026-09-25 15:07 (postop 241h07m)

No screenshot. Manifest stays **140**. The form clock is **2026-09-25T15:07**. 单子类型未填. Notes 无.

- BP **122/33**. Heart rate **83**. Respiratory rate **14**. Norepinephrine **3** mL/h. Dopamine **5** mL/h. CRRT / 尿量: **CRRT在运行**.
- 15:07 is the receipt time, not a monitor clock and not a CRRT start clock.
- RR **14** was added later onto this same clock. Do not add a second `vitalReadings` point. Do not keep the 9/23 RR **13** on this point. No MAP. Do not plot the old MAP 55.
- The `vitalReadings` point stays at h **241.12**, label **9月25日15:07**, with `sbp: 122`, `dbp: 33`, `hr: 83`, `rr: 14`, `ne: 3`, `da: 5`. No `map`.
- Dopamine **6 → 5**. Norepinephrine stays **3 mL/h = 0.15 mg/h**. Do not convert dopamine to mg/h.
- CRRT is now recorded as running. Do not invent flow, UF, anticoagulation, or a run length. Do not copy 130 mL/min or UF 300.
- Urine was blank. The 00:22 urine **0** stays on that older oral.
- `latestNonBloodGasReport` is `{ h: 241.12, label: "术后241h07m · CRRT在运行", type: "口述" }`. That clock was the hero until the 17:28 ABG.
- **Judgment:** record the numbers that were written. Circulatory card moves off the 15:50 130/30 point. Kidney card still shows creatinine 227.10 because it was not redrawn.

### Potassium — 2026-09-25 14:13:06 (postop 240h13m)

Screenshot: `testset/reports/chemistry/20260925T141306__k.jpg`. Manifest **141** at this file, later **143** with the same-day APTT and ABG. Sheet clock is **14:13:06**. The phone status bar 4:08 is not the report clock. Oral fields were all 未填.

- Standalone dry-chemistry potassium. K **3.99** mmol/L (ref 3.5–5.3). No abnormal flag.
- Creatinine, urea, and sodium are not on this sheet.
- Relative hour **240.22**. Label **术后240h13m**.
- **Judgment:** potassium eased **4.52 → 3.99** and stayed inside the reference. Do not invent other chemistry. Do not add a `vitalReadings` point.

### Coag — 2026-09-25 14:21:37 (postop 240h21m)

Screenshot: `testset/reports/coag/20260925T142137__aptt.jpg`. Sheet clock is **14:21:37**. The phone status bar 4:08 is not the report clock.

- Standalone APTT **56.9↑** sec (ref 21–45). Not marked critical.
- INR, PT, TT, and fibrinogen are not on this sheet.
- 56.9 is APTT seconds, not P/F.
- Relative hour **240.36**. Label **术后240h21m**.
- **Judgment:** APTT rose **48.5 → 56.9**. Do not carry 07:52 INR **0.97** or Fbg **4.86** as redrawn.

### Arterial ABG — 2026-09-25 17:28:57 (postop 243h28m)

Screenshot: `testset/reports/abg/20260925T172857__abg.jpg`. Manifest **143**. Sheet clock is **17:28:57**. Oral fields were all 未填.

- pH **7.385** (in 7.35–7.45; was 7.393). PCO₂ **39.70**. HCO₃⁻ **23.20**. ABE **−1.80**. SBE **−1.60**. Store ABE.
- Lactate **1.56** (was 1.30; ref 0.5–1.6). No high flag. Near the top of the range.
- PO₂ **64.20↓** (was 66.80). FiO₂ still **60%**. Printed P/F **107↓** (pO2(a)/FO2(I), ref 400–500). 64.20 / 0.60 = 107. The **0.17%** row is not P/F and not procalcitonin.
- Hb **8.90↓** g/dL (was 9.50). Hct **26%**. iCa **1.10↓** (was 1.06). sO₂ **91.00↓**.
- Relative hour **243.48**. Label **术后243h28m**.
- `latestNonBloodGasReport` stays `{ h: 241.12, label: "术后241h07m · CRRT在运行", type: "口述" }`. That clock was the hero until the 17:57 / 18:07 labs.
- **Judgment:** lactate moved up inside the reference. P/F is back to 107. Do not add a `vitalReadings` point. Circulation stays on the 15:07 122/33 oral.

### Coag — 2026-09-25 17:57:10 (postop 243h57m)

Screenshot: `testset/reports/coag/20260925T175710__aptt.jpg`. Manifest later **145** with the 18:07 potassium. Sheet clock is **17:57:10**. The phone status bar 6:24 is not the report clock. No oral with this batch.

- Standalone APTT **63.9↑** sec (ref 21–45). Not marked critical.
- INR, PT, TT, and fibrinogen are not on this sheet.
- 63.9 is APTT seconds, not P/F.
- Relative hour **243.95**. Label **术后243h57m**.
- **Judgment:** APTT rose **56.9 → 63.9**. Do not carry 07:52 INR **0.97** or Fbg **4.86** as redrawn.

### Potassium — 2026-09-25 18:07:03 (postop 244h07m)

Screenshot: `testset/reports/chemistry/20260925T180703__k.jpg`. Manifest **145**. Sheet clock is **18:07:03**. The phone status bar 6:24 is not the report clock.

- Standalone dry-chemistry potassium. K **3.933** mmol/L (ref 3.5–5.3). No abnormal flag.
- Creatinine, urea, and sodium are not on this sheet.
- Relative hour **244.12**. Label **术后244h07m**.
- `latestNonBloodGasReport` was `{ h: 244.12, label: "术后244h07m · 钾 3.933", type: "生化" }` until the 21:33 labs.
- **Judgment:** potassium stayed inside the reference. This clock was newer than the 17:28 ABG, so the hero followed the potassium sheet until 21:33. Do not add a `vitalReadings` point. Circulation stays on the 15:07 122/33 oral.

### Arterial ABG — 2026-09-25 21:10:08 (postop 247h10m)

Screenshot: `testset/reports/abg/20260925T211008__abg.jpg`. Manifest later **148** with the 21:33 sheets. Sheet clock is **21:10:08**. The phone status bar 21:43 on the later crops is not this report clock. Oral fields were all 未填.

- pH **7.350** (at the 7.35–7.45 floor; was 7.385). PCO₂ **43.30**. HCO₃⁻ **23.40**. ABE **−2.20**. SBE **−2.20**. Store ABE.
- Lactate **1.57** (was 1.56; ref 0.5–1.6). No high flag. Near the top of the range.
- PO₂ **72.00↓** (was 64.20). FiO₂ still **60%**. Printed P/F **120↓** (pO2(a)/FO2(I), ref 400–500). 72.00 / 0.60 = 120. The **0.19%** row is not P/F and not procalcitonin.
- Hb **9.30↓** g/dL (was 8.90). Hct **27%**. iCa **1.12↓** (was 1.10). sO₂ **92.40↓**.
- Relative hour **247.17**. Label **术后247h10m**.
- **Judgment:** lactate stayed inside the reference. P/F rose 107 → 120 and is still far below 400. pH is on the floor. Do not add a `vitalReadings` point. Circulation stays on the 15:07 122/33 oral.

### Potassium — 2026-09-25 21:33:33 (postop 247h33m)

Screenshot: `testset/reports/chemistry/20260925T213333__k.jpg`. Manifest **148**. Sheet clock is **21:33:33**. The phone status bar 21:43 is not the report clock.

- Standalone dry-chemistry potassium. K **4.077** mmol/L (ref 3.5–5.3). No abnormal flag.
- Creatinine, urea, and sodium are not on this sheet.
- Relative hour **247.56**. Label **术后247h33m**.
- **Judgment:** potassium stayed inside the reference. This is not procalcitonin and not P/F.

### Coag — 2026-09-25 21:33:36 (postop 247h33m)

Screenshot: `testset/reports/coag/20260925T213336__aptt.jpg`. Manifest **148**. Sheet clock is **21:33:36**. The phone status bar 21:43 is not the report clock.

- Standalone APTT **67.1↑** sec (ref 21–45). Not marked critical.
- INR, PT, TT, and fibrinogen are not on this sheet.
- 67.1 is APTT seconds, not P/F.
- Relative hour **247.56**. Label **术后247h33m**.
- `latestNonBloodGasReport` was `{ h: 247.56, label: "术后247h33m · APTT 67.1", type: "凝血" }` until the 01:30 labs.
- **Judgment:** APTT rose **63.9 → 67.1**. Do not carry 07:52 INR **0.97** or Fbg **4.86** as redrawn. This clock was newer than the 21:10 ABG, so the hero followed APTT until 01:30. Do not add a `vitalReadings` point. Circulation stays on the 15:07 122/33 oral.

### Arterial ABG — 2026-09-26 01:04:37 (postop 251h4m)

Screenshot: `testset/reports/abg/20260926T010437__abg.jpg`. Manifest later **151** with the 01:29 / 01:30 sheets. Sheet clock is **01:04:37**. The phone status bar 01:49 on the later crops is not this report clock. Oral fields were all 未填.

- pH **7.348↓** (below 7.35–7.45; was 7.350). PCO₂ **41.90**. HCO₃⁻ **22.50**. ABE **−3.10↓** (ref −3 to 3). SBE **−2.90**. Store ABE.
- Lactate **1.338** (was 1.57; ref 0.5–1.6). No high flag.
- PO₂ **69.50↓** (was 72.00). FiO₂ still **60%**. Printed P/F **116↓** (pO2(a)/FO2(I), ref 400–500). 69.50 / 0.60 = 116. The **0.18%** row is not P/F and not procalcitonin.
- Hb **8.60↓** g/dL (was 9.30). Hct **25%**. iCa **1.14↓** (was 1.12). sO₂ **92.20↓**.
- Relative hour **251.08**. Label **术后251h4m**.
- **Judgment:** lactate moved down inside the reference. P/F eased 120 → 116 and is still far below 400. pH left the floor. Do not add a `vitalReadings` point. Circulation stays on the 15:07 122/33 oral.

### Potassium — 2026-09-26 01:29:52 (postop 251h29m)

Screenshot: `testset/reports/chemistry/20260926T012952__k.jpg`. Manifest **151**. Sheet clock is **01:29:52**. The phone status bar 01:49 is not the report clock.

- Standalone dry-chemistry potassium. K **4.333** mmol/L (ref 3.5–5.3). No abnormal flag.
- Creatinine, urea, and sodium are not on this sheet.
- Relative hour **251.50**. Label **术后251h29m**.
- **Judgment:** potassium stayed inside the reference. This is not procalcitonin and not P/F.

### Coag — 2026-09-26 01:30:04 (postop 251h30m)

Screenshot: `testset/reports/coag/20260926T013004__aptt.jpg`. Manifest **151**. Sheet clock is **01:30:04**. The phone status bar 01:49 is not the report clock.

- Standalone APTT **67.2↑** sec (ref 21–45). Not marked critical.
- INR, PT, TT, and fibrinogen are not on this sheet.
- 67.2 is APTT seconds, not P/F.
- Relative hour **251.50**. Label **术后251h30m**.
- `latestNonBloodGasReport` is `{ h: 251.50, label: "术后251h30m · APTT 67.2", type: "凝血" }`. Hero followed APTT until the 07:14 ABG.
- **Judgment:** APTT moved **67.1 → 67.2**. Do not carry 07:52 INR **0.97** or Fbg **4.86** as redrawn. This clock was newer than the 01:04 ABG, so the hero followed APTT until 07:14. Do not add a `vitalReadings` point. Circulation stays on the 15:07 122/33 oral.

### Arterial ABG — 2026-09-26 07:14:26 (postop 257h14m)

Screenshot: `testset/reports/abg/20260926T071426__abg.jpg`. Manifest **152**. Sheet clock is **07:14:26**. Oral clock **2026-09-26T07:14**; 单子类型 / BP / HR / NE / DA / CRRT / 尿量 / 其他 were all 未填 or 无.

- pH **7.383** (in 7.35–7.45; was 7.348↓). PCO₂ **39.20**. HCO₃⁻ **22.80**. ABE **−2.20**. SBE **−2.00**. Store ABE.
- Lactate **1.76↑** (was 1.338; ref 0.5–1.6). Flagged high.
...
- A later same-clock crop also shows PCT/PCCT **7.209↑** ng/mL (ref 0–0.05). Still no K, Na, Cl, or albumin.
- Relative hour **259.00**. Label **术后258h59m**.
- `latestNonBloodGasReport` was `{ h: 259.00, label: "术后258h59m · 肌酐 159", type: "生化" }` until the 09:36 coag.
- **Judgment:** creatinine and urea moved down and remain high on this sheet’s refs. Transaminases and CK returned inside the reference; bilirubin is newly high here. PCT **7.209** is procalcitonin on this chemistry clock, not plateletcrit. Do not add a `vitalReadings` point. Circulation stays on the 15:07 122/33 oral.

### Coag — 2026-09-26 09:36:42 (postop 259h36m)

Screenshot: `testset/reports/coag/20260926T093642__coag.jpg`. Manifest **155**. Sheet clock is **09:36:42**. The phone status bar 9:59 is not the report clock. Oral clock **2026-09-26T09:36**; all vital fields 未填.

- APTT **43.7↑** (was 67.2). This sheet ref **23.3–32.5**, not 21–45. Not marked critical. Do not treat 43.7 as back inside 21–45.
- TT **14.4** (14–21). PT **13.5** (11–14.3). PT% **68.0↓** (80–120). INR **1.19** (0.94–1.2). Fbg **5.033↑** g/L (2–4.5).
- 43.7 is APTT seconds, not P/F.
- Relative hour **259.61**. Label **术后259h36m**.
- `latestNonBloodGasReport` was `{ h: 259.61, label: "术后259h36m · APTT 43.7", type: "凝血" }` until the 13:00 oral.
- **Judgment:** APTT moved down and is still flagged high on this tighter range. A later same-clock copy adds no new numbers. Do not add a `vitalReadings` point. Circulation stays on the 15:07 122/33 oral.

### Chemistry PCT crop — 2026-09-26 08:59:45 (same clock)

Screenshot: `testset/reports/chemistry/20260926T085945__5DF7436C-4570-4915-9A0A-34B616E804D1_L0_001.jpg`. Preferred. Old `20260926T085945__chem.jpg` kept, `preferred: false`, `superseded_by` this file. Manifest later **158**.

- Same values as the first 08:59 crop, plus PCT/PCCT **7.209↑** ng/mL (ref 0–0.05). Printed AST/ALT **1.37**.
- This is procalcitonin, not plateletcrit 0.13% and not P/F 118.
- Phone status bar 9:59 is not the report clock.
...
### Oral — 2026-09-26 13:00 receipt (postop 263h)

No new screenshot. Receipt clock is the chat timestamp 2026-09-26 05:00 UTC = 13:00 CST.

- CRRT **今天早上七点多停了**. Not exactly 07:00. No flow / UF / anticoagulation / run length.
- Urine **没有尿** → **0**.
- Spontaneous breathing; not completely ventilator-dependent. No new ventilator numbers.
- Dr. Lu: bacterial infection still severe. Current antibiotic is broad-spectrum, strong, mainly against bacilli; name not given. Cocci culture started.
- No fever. Doctor offered two possibilities (drug suppression vs immune cells giving up). Record as the doctor’s oral, not a diagnosis, and do not invent a temperature.
- No new BP / HR / NE / DA. Do not add a `vitalReadings` point.
- `latestNonBloodGasReport` was `{ h: 263.00, label: "术后263h · CRRT已停 · 尿量0", type: "口述" }` until the 15:00 oral. Hero was **最新口述：术后263h · CRRT已停 · 尿量0**.

### Oral — 2026-09-26 15:00 receipt (postop 265h)

No new screenshot. Structured oral clock **2026-09-26T15:00**. Relative hour **265.00**. Label **9月26日15:00**.

- BP **110/30**. Heart rate **100**. No MAP. No RR — do not carry 15:07 RR **14**.
- Norepinephrine **5 mL/h = 0.25 mg/h** (0.05 mg/mL). Dopamine **4 mL/h**. Do not convert dopamine to mg/h. Do not invent weight.
- CRRT / 尿量: **上午七点CRRT暂停，仍无尿**. 上午七点 is more specific than 七点多, still not exactly 07:00.
- Fever **37.4**.
- Doctor thinks remaining small intestine is little, temporarily cannot eat, possible abdominal bacterial translocation / secondary infection. Record as 医生认为, not a diagnosis.
