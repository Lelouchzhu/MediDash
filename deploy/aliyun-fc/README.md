...
`main` 已经记入 2026-09-26 13:00 口述、10:30 培养和 08:59 降钙素原。打开后应看到：

- 顶栏：**最新口述：术后263h · CRRT已停 · 尿量0**，并且有 **上传化验**
- 灌注：乳酸 **1.76**↑（0.5–1.6外；卡片数值会显示 **1.76**）
- 酸碱：pH **7.383**，PCO₂ **39.2**，HCO₃⁻ **22.8**，BE **−2.2**
- 氧合：P/F **118**，FiO₂ **60%**，口述有自主呼吸
- 感染：白细胞 **29.72**，降钙素原 **7.209**，培养 **肺炎克雷伯菌**
- 肾功能：肌酐 **159**，尿素 **16.055**。CRRT七点多停了。尿量 **0**
...
若顶栏仍是术后259h 或最新还是 APTT 43.7，打开的是旧页面。
