...
`main` 已经记入 2026-09-26 15:00 口述。打开后应看到：

- 顶栏：**最新口述：术后265h · 110/30**，并且有 **上传化验**
- 灌注：乳酸 **1.76**↑（0.5–1.6外；卡片数值会显示 **1.76**）
- 酸碱：pH **7.383**，PCO₂ **39.2**，HCO₃⁻ **22.8**，BE **−2.2**
- 氧合：P/F **118**，FiO₂ **60%**，口述有自主呼吸
- 感染：白细胞 **29.72**，降钙素原 **7.209**，培养 **肺炎克雷伯菌**，发烧 **37.4**
- 肾功能：肌酐 **159**，尿素 **16.055**。CRRT上午七点暂停。仍无尿
- 肝：ALT **19**，AST **26**，总胆红素 **21.8**
- 血红蛋白：血常规 **88**，血气 **9.6**，iCa **1.16**
- 凝血：APTT **43.7**，INR **1.19**，纤维蛋白原 **5.033**。这张参考 23.3–32.5
- 循环卡是 15:00 的 **110/30**，心跳 **100**，去甲 **5**，多巴胺 **4**，未说呼吸

若顶栏仍是术后263h 或最新还是 CRRT已停，打开的是旧页面。
