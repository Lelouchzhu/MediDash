...
`main` 已经记入 2026-09-26 09:36 凝血。打开后应看到：

- 顶栏：**最新化验：术后259h36m · APTT 43.7**，并且有 **上传化验**
- 灌注：乳酸 **1.76**↑（0.5–1.6外；卡片数值会显示 **1.76**）
- 酸碱：pH **7.383**，PCO₂ **39.2**，HCO₃⁻ **22.8**，BE **−2.2**
- 氧合：P/F **118**，FiO₂ **60%**，PO₂ **71.1**
- 感染：白细胞 **29.72**，降钙素原仍 **9.893**
- 肾功能：肌酐 **159**，尿素 **16.055**。15:07 口述 CRRT在运行。钾 **4.333**
- 肝：ALT **19**，AST **26**，总胆红素 **21.8**
- 血红蛋白：血常规 **88**，血气 **9.6**，iCa **1.16**
- 凝血：APTT **43.7**，INR **1.19**，纤维蛋白原 **5.033**。这张参考 23.3–32.5
- 循环卡是 15:07 的 **122/33**，心跳 **83**，呼吸 **14**，去甲 **3**，多巴胺 **5**
- 00:22 尿量仍为 **0** 留在时间线；这次没有新的尿量

若顶栏仍是术后258h 或最新还是肌酐 159，打开的是旧页面。
