...
`main` 已经记入 2026-09-25 17:57 APTT 和 18:07 钾。打开后应看到：

- 顶栏：**最新化验：术后244h07m · 钾 3.933**，并且有 **上传化验**
- 灌注：乳酸 **1.56**（0.5–1.6内，贴近上限）
- 酸碱：pH **7.385**，PCO₂ **39.7**，HCO₃⁻ **23.2**，BE **−1.8**
- 氧合：P/F **107**，FiO₂ **60%**，PO₂ **64.2**
- 感染：降钙素原 **9.893**，白细胞 **24.15**
- 肾功能：肌酐 **227.10**，尿素 **25.80**。15:07 口述 CRRT在运行。钾 **3.933**
- 血红蛋白：血气 **8.9**，血常规 **87**，iCa **1.10**
- 凝血：APTT **63.9**。INR 和纤维蛋白原这张没抽
