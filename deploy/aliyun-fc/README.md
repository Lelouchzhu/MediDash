...
`main` 已经记入 2026-09-26 01:04 血气、01:29 钾和 01:30 APTT。打开后应看到：

- 顶栏：**最新化验：术后251h30m · APTT 67.2**，并且有 **上传化验**
- 灌注：乳酸 **1.338**（0.5–1.6内；卡片数值会显示 **1.34**）
- 酸碱：pH **7.348**↓，PCO₂ **41.9**，HCO₃⁻ **22.5**，BE **−3.1**↓
- 氧合：P/F **116**，FiO₂ **60%**，PO₂ **69.5**
- 感染：降钙素原 **9.893**，白细胞 **24.15**
- 肾功能：肌酐 **227.10**，尿素 **25.80**。15:07 口述 CRRT在运行。钾 **4.333**
- 血红蛋白：血气 **8.6**，血常规 **87**，iCa **1.14**
- 凝血：APTT **67.2**。INR 和纤维蛋白原这张没抽
- 循环卡是 15:07 的 **122/33**，心跳 **83**，呼吸 **14**，去甲 **3**，多巴胺 **5**
- 00:22 尿量仍为 **0** 留在时间线；这次没有新的尿量

若顶栏仍是术后247h 或凝血还是 67.1，打开的是旧页面。
