...
`main` 已经记入 2026-09-25 21:10 血气、21:33 钾和 21:33 APTT。打开后应看到：

- 顶栏：**最新化验：术后247h33m · APTT 67.1**，并且有 **上传化验**
- 灌注：乳酸 **1.57**（0.5–1.6内，贴近上限）
- 酸碱：pH **7.350**，PCO₂ **43.3**，HCO₃⁻ **23.4**，BE **−2.2**
- 氧合：P/F **120**，FiO₂ **60%**，PO₂ **72.0**
- 感染：降钙素原 **9.893**，白细胞 **24.15**
- 肾功能：肌酐 **227.10**，尿素 **25.80**。15:07 口述 CRRT在运行。钾 **4.077**
- 血红蛋白：血气 **9.3**，血常规 **87**，iCa **1.12**
- 凝血：APTT **67.1**。INR 和纤维蛋白原这张没抽
- 循环卡是 15:07 的 **122/33**，心跳 **83**，呼吸 **14**，去甲 **3**，多巴胺 **5**
- 00:22 尿量仍为 **0** 留在时间线；这次没有新的尿量

若顶栏仍是术后244h 或凝血还是 63.9，打开的是旧页面。
