...
- **大陆入口（当前页）**: https://jsd.onmicrosoft.cn/gh/Lelouchzhu/MediDash@41fcbf5/index.xhtml
- 备用国内镜像: https://cdn.jsdmirror.com/gh/Lelouchzhu/MediDash@41fcbf5/index.xhtml

灌注卡应是乳酸 **2.02**，酸碱卡 pH **7.327**，氧合卡 **P/F 167**。肾功能卡应是肌酐 **423**。顶栏应是 **最新检查：术后188h19m · 下肢彩超**。若顶栏还是肌酐 423，打开的还是旧镜像。下次更新后把 `41fcbf5` 换成新提交号，不要改回 `@main`。
...
| [`testset/`](testset/) | Screenshot archive + `manifest.json` (currently 120 reports) |
