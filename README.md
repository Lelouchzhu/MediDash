...
- **大陆入口（当前页）**: https://jsd.onmicrosoft.cn/gh/Lelouchzhu/MediDash@cfc7e21/index.xhtml
- 备用国内镜像: https://cdn.jsdmirror.com/gh/Lelouchzhu/MediDash@cfc7e21/index.xhtml

灌注卡应是乳酸 **2.24**，酸碱卡 pH **7.360**，氧合卡 **P/F 140**。感染卡白细胞 **26.44**，降钙素原 **8.206**。肾功能卡应是肌酐 **185**，尿素 **20.52**，并写 **16:18血滤已停**。血红蛋白卡血气仍是 **10.8**，血常规 **100**。循环卡仍是 **130/30**，心跳 **77**，去甲 **6**，多巴胺 **3**。顶栏应是 **最新口述：术后218h18m · 血滤已停**。查房清单里有芬太尼和氧合指数的问题，页面没有芬太尼剂量。若顶栏还是术后217h50m，打开的还是旧镜像。下次更新后把 `cfc7e21` 换成新提交号，不要改回 `@main`。
