...
灌注卡应是乳酸 **2.24**，酸碱卡 pH **7.360**，氧合卡 **P/F 140**。感染卡白细胞 **26.44**，降钙素原 **8.206**。肾功能卡应是肌酐 **185**，尿素 **20.52**，尿量仍为 **0**。血红蛋白卡血气仍是 **10.8**，血常规 **100**。循环卡应是 **130/30**，心跳 **77**，去甲 **6**，多巴胺 **3**。顶栏应是 **最新口述：术后217h50m · 血压 130/30**。若顶栏还是术后211h31m，打开的还是旧镜像。下次更新后把 `2b92beb` 换成新提交号，不要改回 `@main`。
